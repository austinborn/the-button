...
contract TheButton {
  ...
  event ButtonPressed(address);
  event TreasureClaimed(address, uint);

  /**
   * @notice - Constructor which accepts a _press_fee argument
